...
import { buildReactivatedCandidateSummary, createLatestMembershipRequest, parseSuitableRoles } from "./talentController.js";
...
function PoolDetail({ pool, pools, memberships, candidates, positions, onBack, onUpdatePool, onDeletePool, onUpdateMember, onMove, onRemove, onReferMember, onReactivateCandidate, onOpenCandidate, onNotify, status = "ready", error = "", onRetry, nextCursor, loadingMore, onLoadMore }) {
  ...
  const [editOpen, setEditOpen] = useState(false); const [deleteOpen, setDeleteOpen] = useState(false); const [actionMessage, setActionMessage] = useState(""); const [deleting, setDeleting] = useState(false);
