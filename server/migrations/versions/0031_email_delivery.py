...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("encrypted_password", sa.LargeBinary(), nullable=False), sa.Column("enabled", sa.Boolean(), nullable=False, server_default=sa.false()),
        ...
        sa.PrimaryKeyConstraint("id"), sa.UniqueConstraint("organization_id"), sa.UniqueConstraint("organization_id", "id"),
    ...
    op.create_table(
        ...
        sa.Column("business_dedupe_key", sa.String(255), nullable=False), sa.Column("parent_delivery_id", sa.Uuid()),
        ...
        sa.ForeignKeyConstraint(["organization_id"], ["organizations.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(["organization_id", "provider_config_id"], ["email_provider_configs.organization_id", "email_provider_configs.id"]),
