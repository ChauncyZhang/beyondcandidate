...
class EmailProviderConfig(Base):
    ...
    __table_args__ = (
        UniqueConstraint("organization_id"), UniqueConstraint("organization_id", "id"),
...
class EmailDelivery(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(["organization_id"], ["organizations.id"], ondelete="CASCADE"),
        ForeignKeyConstraint(["organization_id", "provider_config_id"], ["email_provider_configs.organization_id", "email_provider_configs.id"]),
